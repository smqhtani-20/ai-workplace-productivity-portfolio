...
> "Write an email about the timeline update."

**Initial Result:** A generic, unfocused draft — it didn't specify who the audience was, what actually changed, why it changed, or what the reader was supposed to do next. It could have applied to almost any situation, which made it useless without heavy rewriting.

## After (C.A.R.E.-Structured Prompt)

> **Who:** the project team
> **What:** the project delivery date has moved
